  ...
  return (
    <React.Fragment>
      <ModalFlag
        ...
        title={`${country.name.common}'s flag`}
      />
              ...
              <div className="bg-white1 rounded-t-2xl border-t-2 border-blue2 hover:border-blue1">
                <div className="px-4">
                  <div className="flex items-start justify-between relative">
                    <Tooltip
                      arrow
                      title={`Open ${country.name.official}'s flag`}
                    >
                      <Avatar
                        onClick={openModal}
                        ...
                        className="absolute top-[-1rem] cursor-pointer border-[3px] border-white1"
                      />
                    </Tooltip>
